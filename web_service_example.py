...
def detect_faces_in_image(file_stream):
    ...
    known_face_encoding_hardCoded = load_image_file_hardcode()
    picName_atul = "pictures/atul.JPG"
...
#     known_face_encoding_atul = load_image_file(picName_atul)
#     known_face_encoding_obama = load_image_file(picName_obama)
#     known_face_encoding = known_face_encoding_obama.tolist()
#     # print("************************")
#     # print("type(known_face_encoding_atul)) : ", type(known_face_encoding_atul))
#     # # type(known_face_encoding_atul)) :  <class 'numpy.ndarray'>
#     #
#     # print("known_face_encoding_obama and known_face_encoding_atul")
#     # # print(face_recognition.compare_faces([known_face_encoding_atul], [known_face_encoding_obama]))
#
#     # Load the uploaded image file
#     img = face_recognition.load_image_file(file_stream)
#     # Get face encodings for any faces in the uploaded image
